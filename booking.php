...
">
    ...
    <div class="page">
        ...
        <div class="flex justify-evenly bg-blue-100 mb-8">
            <h2 class="text-center text-2xl font-bold text-blue-400">Welcome <span class="text-4xl uppercase text-blue-500"> <?php echo $_SESSION["user"] ?> </span> </h2>
            <h4 class=" text-2xl font-bold text-blue-400">This is your account </h4>
        </div>
    ...
    <div class="flex flex-wrap items-center justify-center p-12">
        ...
        <form method="post" action="confirm.php">
            <div class="mb-5">
                <label for="date" class="mb-3 block text-2xl font-bold text-blue-800">
                    Route
                </label>
                <select list="buses" name="ibuses" id="ibuses" value="" type="text" class="text-blue-700  mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-xl shadow-sm placeholder-slate-400
    ...
    ">
                    ...
                    ?>
                        ...
                        <option value="<?php echo $buses["bus_number"]; ?>">

                            <?php echo $buses["bus_number"] . " " . $buses["trip"] . " " . "&#8358;" . $buses["price"]; ?>
            ...
            <input class="w-48 font-bold text-blue-400 text-xl m-4" type="date" name="date" id="date" />
            <input class="bg-blue-800 p-2 w-48 font-bold text-blue-400 text-xl m-4" type="submit" name="search" value="BOOK" />
        </form>
